    ...
    <Box sx={{ m: 4 }}>
      ...
      <Grid container>
        ...
        <Grid item xs={4}>
          ...
          <Typography>{format(new Date(results.timestamp), "MM-dd-yy HH:mm OOOO")}</Typography>
        </Grid>
      </Grid>
      <Grid container>
        <Grid item xs={4}>
                    ...
                    {results.res
                      ...
                      .map((row: any) => (
                        ...
                        >
                          ...
                          <TableCell>{format(new Date(row.createdAt), "MM-dd-yy HH:mm OOOO")}</TableCell>
                          <TableCell>{format(new Date(row.updatedAt), "MM-dd-yy HH:mm OOOO")}</TableCell>
                          <TableCell>
